 ...
 *   - Note that, no matter what the type of T is, Table will zero-clear the
 * memory.
 */
template <typename T> class Table {
public:
  /**
   * @param bucket_bitnum   bitnum of buckets, bucket_num will be (1 <<
   * bucket_bitnum).
   * @param bucket_bitsize  bitsize of each bucket, bucket_size will be (1 <<
   * bucket_bitsize).
   */
