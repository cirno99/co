...
namespace _xx {
inline fastring join(const fastring &s) { return s; }
...
template <typename... S> inline fastring join(const S &...s) {
...
inline fastring dir(const fastring &s) { return clean(split(s).first); }
