...
public:
  ...
  fastream &append(short v) { return this->append(&v, sizeof(v)); }

  fastream &append(unsigned short v) { return this->append(&v, sizeof(v)); }

  fastream &append(int v) { return this->append(&v, sizeof(v)); }

  fastream &append(unsigned int v) { return this->append(&v, sizeof(v)); }

  fastream &append(long v) { return this->append(&v, sizeof(v)); }

  fastream &append(unsigned long v) { return this->append(&v, sizeof(v)); }

  fastream &append(long long v) { return this->append(&v, sizeof(v)); }

  fastream &append(unsigned long long v) { return this->append(&v, sizeof(v)); }
  ...
  // Special optimization for string literal like "hello". The length of a
  // string literal can be get at compile-time, no need to call strlen().
