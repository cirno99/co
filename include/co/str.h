...
inline std::vector<fastring> split(const fastring &s, const char *c,
                                   uint32 n = 0) {
 ...
 */
__codec fastring replace(const char *s, const char *sub, const char *to,
                         uint32 n = 0);
__codec fastring replace(const fastring &s, const char *sub, const char *to,
                         uint32 n = 0);
 ...
 * @param s  the string, either a null-terminated string or a reference of
 * fastring.
 * @param c  characters to be stripped, either a single character or a
