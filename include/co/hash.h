 ...
 */
inline uint64 hash64(const void *s, size_t n) { return murmur_hash64(s, n, 0); }

inline uint64 hash64(const char *s) { return hash64(s, strlen(s)); }

inline uint64 hash64(const fastring &s) { return hash64(s.data(), s.size()); }
...
inline uint32 hash32(const char *s) { return hash32(s, strlen(s)); }

inline uint32 hash32(const fastring &s) { return hash32(s.data(), s.size()); }
