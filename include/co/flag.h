...
__codec void add_flag(char type, const char *name, const char *value,
...
#define _CO_DEF_FLAG(type, id, name, value, help)                              \
  __codef type FLG_##name = []() {                                             \
    ::flag::xx::add_flag(id, #name, #value, help, __FILE__, __LINE__,          \
                         &FLG_##name);                                         \
    return value;                                                              \
  }()
...
#define DEF_uint32(name, value, help)                                          \
  _CO_DEF_FLAG(uint32, 'u', name, value, help)
#define DEF_uint64(name, value, help)                                          \
  _CO_DEF_FLAG(uint64, 'U', name, value, help)
#define DEF_double(name, value, help)                                          \
  _CO_DEF_FLAG(double, 'd', name, value, help)

#define DEF_string(name, value, help)                                          \
  fastring FLG_##name = []() {                                                 \
    ::flag::xx::add_flag('s', #name, #value, help, __FILE__, __LINE__,         \
                         &FLG_##name);                                         \
    return value;                                                              \
  }()
